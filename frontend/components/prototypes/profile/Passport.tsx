    ...
    return (
        ...
        >
            ...
            <p className="mt-2 text-sm text-muted-foreground">
                Your identity, your access, your room to build.
            </p>
            <div className="mt-8 grid items-start gap-8 md:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:gap-14">
                <aside className="min-w-0">
                    ...
                    >
                        ...
                        <dl className="grid gap-5 px-5 py-5 sm:px-6">
                            <div>
                                <dt className="mb-2 font-mono text-[11px] uppercase tracking-[0.06em] text-muted-foreground">
                                    Email address
                                </dt>
                    ...
                    <section className="mt-8 px-1" aria-labelledby="passport-credits">
                        <h2 id="passport-credits" className="mb-4 text-sm font-medium">
                            Build credits
                        </h2>
                ...
                <div className="grid min-w-0 gap-9">
                    <section aria-labelledby="passport-details">
                        <h2 id="passport-details" className="text-lg font-medium">
                            Personal details
                        </h2>
                    ...
                    <section
                        ...
                        aria-labelledby="passport-access"
                    >
                        <h2 id="passport-access" className="text-lg font-medium">
                            Sign-in methods
                        </h2>
                        <p className="mt-2 text-sm text-muted-foreground">
                            Choose how you access WebBuilder.
                        </p>
