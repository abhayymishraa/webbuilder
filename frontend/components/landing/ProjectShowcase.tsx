...
import { TiltedPreview } from "@/components/landing/TiltedPreview";
import styles from "@/components/landing/project-showcase.module.css";
        ...
        >
            ...
            {kind === "reading" ? (
                ...
                <div className="showcase-habits pt-7">
                    ...
                    {["Read a few pages", "Take a walk", "Make something"].map((habit, index) => (
                        <div
